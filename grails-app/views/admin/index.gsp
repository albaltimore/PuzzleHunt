...
<body>
    ...
    <div>
        <div>
            <label>Player</label><select style="width: 150px" id='playerSelect'><option /></select>
            <label>Activity</label><select style="width: 150px" id='activitySelect'><option /></select>
